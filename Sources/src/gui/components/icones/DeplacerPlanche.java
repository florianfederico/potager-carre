...
/**
 * 
 * <b>DeplacerPlanche est la classe gérant l'icône qui permet de déplacer une planche sélectionnée.</b>
 * 	<p>
 ...
 *
 */
public class DeplacerPlanche extends Icone
{
	 ...
	 * 
	 */
	public DeplacerPlanche(Fenetre f, HashMap<String,String> params)
	{
	 ...
	 * @param i instance de DeplacerPlanche
	 */
	public DeplacerPlanche(DeplacerPlanche i)
	{
		super(i);
	}
	/**
	 ...
	 * @return i un icône DeplacerPlanche
	 * 
	 * */
	public Icone clone()
	{
		Icone i=new DeplacerPlanche(this);
		return i;
	}
	/**
	 * 
