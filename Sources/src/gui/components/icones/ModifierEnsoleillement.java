...
/**
 * 
 * <b>ModifierEnsoleillement est la classe gérant l'icône qui permet de changer l'ensoleillement du carré sélectionné.</b>
 * 	<p>
 ...
 *
 */
public class ModifierEnsoleillement extends Icone
{
	 ...
	 * 
	 */
	public ModifierEnsoleillement(Fenetre f, HashMap<String,String> params)
	{
	 ...
	 * 
	 */
	public ModifierEnsoleillement(Icone i) 
	{
		super(i);
	...
	protected void initEvent() 
	{
		...
		(
			...
			new MouseListener()
			{
				 ...
				 * Le frame change en appellant la fonction adéquate
	 ...
	 * @return i un icône ModifierEnsoleillement
	 * 
	 * */
	public Icone clone()
	{
		Icone i=new ModifierEnsoleillement(this);
		return i;
	}
	/**
	 * 
