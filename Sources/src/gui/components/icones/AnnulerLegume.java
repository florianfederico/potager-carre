...
/**
 * 
 * <b>AnnulerLegume est la classe gérant l'icône qui annule le placement d'un légume pour un carré.</b>
 * 	<p>
 ...
 *
 */
public class AnnulerLegume extends Icone
{
	 ...
	 * 
	 */
	public AnnulerLegume(Fenetre f, HashMap<String,String> params)
	{
	 ...
	 * @param i instance de AnnulerLegume
	 * 
	 */
	private AnnulerLegume(AnnulerLegume i) 
	{
		super(i);
	}
	 ...
	 * @return i un icône AnnulerLegume
	 * 
	 * */
	public Icone clone()
	{
		Icone i=new AnnulerLegume(this);
		return i;
	}
