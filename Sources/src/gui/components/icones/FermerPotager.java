...
/**
 * 
 * <b>FermerPotager est la classe gérant l'icône qui permet de quitter le potager.</b>
 * 	<p>
 ...
 *
 */
public class FermerPotager extends Icone
{
	 ...
	 * 
	 */
	public FermerPotager(Fenetre f, HashMap<String,String> params)
	{
	 ...
	 * @param i instance de FermerPotager
	 * 
	 */
	public FermerPotager(FermerPotager i)
	{
		super(i);
	}
	 ...
	 * @return i un icône FermerPotager
	 * 
	 * */
	public Icone clone()
	{
		Icone i=new FermerPotager(this);
		return i;
	}
	/**
	 * 
